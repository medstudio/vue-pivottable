<template>
  <div id="app">
    <div class="title">
      <h1>testing for kennect : Vue Pivottable</h1>
      <small>Sample Dataset: Items ({{ filteredData.length }})</small>
    </div>
    <div>
    ...
    >
      <div slot="aggregatorCell">
        Testing
        <select v-model="v2agrs[0].agr">
          <option value="Sum" >Sum</option>
          <option value="Count" :selected="true">Count</option>
        </select>
        <select v-model="v2agrs[0].col">
          <option value="AvgSales" >AvgSales</option>
  ...
  data() {
    return {
      ...
      attributes: [
        ...
        "RATE",
        "REPS",
        "PER TM MTH TGT VAL 2019-20",
        "HQ TGT QTY MTH  2019-20",
        "HQ ANN TGT QTY 2019-20",
        "HQ TGT VAL MTH 2019-20",
        "HQ ANN TGT VAL 2019-20",
        "LAST_YEAR AVG VAL 2018-19",
        "LY_QTY ANN 2018-19",
        "LY_VAL  ANN 2018-19",
        "Q GRTH% 2019-20",
        "Val GRTH % 2019-20",
      ],
      // ['Unused 1', 'Meal', 'Payer Smoker', 'Day of Week', 'Payer Gender', 'Party Size'],
      rows: [],
      cols: [],
      vals: ["HQ TGT QTY MTH  2019-20", "AvgSales"],
      ...
      aggs: {
        "Number of MPs": function () {
          return tpl.count()();
        },
        "Average Age of MPs": function () {
          return tpl.average()(["Age"]);
        },
      },
      rendererName: "Table",
      localeStrings: {
